...
def main():
    ...
    parser.add_argument("--output", type=str, default=None,
                        help="输出文件路径 (默认: data/raw/uniprot/human_all_sequences.fasta)")
    parser.add_argument("--no-reviewed", action="store_true",
                        help="跳过 reviewed (Swiss-Prot) 蛋白")
    parser.add_argument("--no-unreviewed", action="store_true",
                        help="跳过 unreviewed (TrEMBL) 蛋白")
