...
class TestGeneMapper:
    ...
    def test_map_gene_to_uniprot_timeout_returns_none_without_fallback(self, mock_protmapper, monkeypatch):
    ...
    def test_map_genes_batch_timeout_returns_none_without_fallback(self, mock_protmapper, monkeypatch):
...
class TestRequestsFallbackMapper:
    ...
    def test_build_mapper_uses_protmapper_when_available(self, monkeypatch):
        ...
        sentinel = object()
        monkeypatch.setattr("src.analysis.gene_mapper._HAS_UNIPROT_MAPPER", True)
        monkeypatch.setattr(
    ...
    def test_build_mapper_falls_back_when_package_missing(self, monkeypatch):
        ...
        monkeypatch.setattr("src.analysis.gene_mapper._HAS_UNIPROT_MAPPER", False)
    ...
    def test_requests_mapper_success(self):
        ...
        with (
            patch("src.analysis.gene_mapper.requests.post", return_value=submit_resp),
    ...
    def test_requests_mapper_paginates_beyond_first_page(self):
        ...
        page_two.json.return_value = {"results": [{"from": "G500", "to": {"primaryAccession": "P50000"}}]}
        page_two.links = {}
