...
**Last updated: 2026-08-09（综合审计、checkpoint/NPZ 修复与最终回归后）**

当前权威分析是仓库根目录的
[`project_analysis_20260809.md`](https://github.com/valleyhe/PTM2CellNET/blob/main/project_analysis_20260809.md)；此前的
...
- **测试基线**：完整 `pytest -q` 为 **1920 passed、13 skipped、28 warnings**；默认 coverage 门禁为 **1866 passed、5 skipped、branch coverage 75.27%**，`fail_under=74`。
